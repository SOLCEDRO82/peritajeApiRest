...
$router->addRoute ('siniestros/:id', 'DELETE', 'SiniestroApiController', 'delete');
$router->addRoute ('siniestros',     'POST', 'SiniestroApiController', 'add');
$router->addRoute ('siniestros/:id',  'PUT', 'SiniestroApiController', 'update');
